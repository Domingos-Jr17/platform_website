    ...
    <div className="pt-24">
      ...
      <section className="bg-[var(--primary)] text-white py-16">
        <div className="container mx-auto px-6 text-center">
          ...
          >
            Conheça nossa história, missão, visão e valores que nos tornam referência no mercado moçambicano
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-3xl font-bold mb-6" style={{color: '#003366'}}>Quem Somos</h2>
            ...
            <motion.div 
              className="relative rounded-xl h-80 overflow-hidden"
              initial={{ opacity: 0, x: 30 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
            ...
            >
              <Image 
                src="https://placehold.co/600x400/E0E0E0/808080?text=Nossa+Equipe"
                alt="Imagem da equipe ou escritório"
                layout="fill"
                objectFit="cover"
              />
              {/* TODO: Substituir por imagem real da equipe ou escritório */}
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <div className="bg-blue-100 text-[var(--primary)] w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4">
                <Shield size={32} />
              </div>
              ...
              <div className="space-y-12">
                ...
                >
                  <div className="md:w-1/2 md:pr-8 text-right">
                    <div className="bg-blue-100 text-[var(--primary)] inline-block px-4 py-2 rounded-full mb-2">
                      <History className="inline mr-2" size={16} /> 2008
                    </div>
                    <h3 className="text-xl font-bold mb-2">Fundação da Platform</h3>
                    <p className="text-gray-600">
                      Início das operações como corretora de seguros em Maputo, com foco em atendimento personalizado.
                    </p>
                  </div>
                  <div className="md:w-1/2 md:pl-8 mt-4 md:mt-0">
                    <div className="bg-white border-4 border-[var(--primary)] rounded-full w-16 h-16 flex items-center justify-center mx-auto md:mx-0">
                ...
                >
                  ...
                  <div className="md:w-1/2 md:pl-8 md:order-1 mt-4 md:mt-0">
                    <div className="bg-white border-4 border-[var(--primary)] rounded-full w-16 h-16 flex items-center justify-center mx-auto md:mx-0 md:ml-auto">
                ...
                >
                  <div className="md:w-1/2 md:pr-8 text-right">
                    ...
                    <h3 className="text-xl font-bold mb-2">Transformação Digital</h3>
                    <p className="text-gray-600">
                ...
                >
                  <div className="md:w-1/2 md:pr-8 md:order-2">
                    ...
                    <h3 className="text-xl font-bold mb-2">Referência no Mercado</h3>
                    <p className="text-gray-600">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-6">
          <motion.div 
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl font-bold mb-4" style={{color: '#003366'}}>Nossa Equipe</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
            ...
            {[1, 2, 3, 4].map((item, index) => (
              ...
              >
                <div className="relative bg-gray-200 h-48 flex items-center justify-center">
                  <Image 
                    src={`https://placehold.co/300x200/E0E0E0/808080?text=Profissional+${item}`}
                    alt={`Foto do profissional ${item}`}
                    layout="fill"
                    objectFit="cover"
                  />
                  {/* TODO: Substituir por foto real do profissional */}
                </div>
                <div className="p-6">
                  <h3 className="text-xl font-bold mb-1">Nome do Profissional</h3>
